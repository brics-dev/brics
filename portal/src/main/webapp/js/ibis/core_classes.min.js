...
// TemplateManager
var TemplateManager={templates:{},addTemplate:function(t,e){if(!_.isFunction(e))throw new Error("template "+t+" is invalid during registration");return this.templates[t]=e},getTemplate:function(t){var e=this.templates[t];if(null==e)try{e=this._retrieveTemplate(t)}catch(t){throw t}return e},initPartials:function(){$(".handlebarsPartial").each(function(){var t=$(this);Handlebars.registerPartial(t.attr("id"),t.html())})},initOnePartial:function(t){var e=$("#"+t);if(!(0<e.length))throw new Error("partial "+t+" not found");var a=e.html();if(""===a)throw new Error("partial "+t+" is empty");Handlebars.registerPartial(e.attr("id"),a)},initAsync:function(a){$('script[type="text/x-handlebars-template"][src]').each(function(){var e=$(this);$.ajax({url:e.attr("src"),success:function(t){TemplateManager.addTemplate(e.attr("id"),Handlebars.compile(t)),a()}})})},loadNewAsync:function(a,t,r){this.templates[a]?r(this.templates[a]):$.ajax({url:t,dataType:"html",success:function(t){var e=TemplateManager.addTemplate(a,Handlebars.compile(t));r(e)}})},_retrieveTemplate:function(t){var e=$("#"+t);if(0<e.length){var a=e.html();if(""!==a){var r=Handlebars.compile(a);return this.addTemplate(t,r),r}throw new Error("template "+t+" is empty")}throw new Error("template "+t+" not found")}};
