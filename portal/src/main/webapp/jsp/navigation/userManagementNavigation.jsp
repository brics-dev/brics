...
<div id="left-sidebar">
		...
		<sec:authorize access="hasAnyRole('ROLE_ADMIN', 'ROLE_ACCOUNT_ADMIN')">
			<li id="managingUsersLink"><s:a href="%{modulesAccountURL}accountAdmin/accountAction!list.action">Account Admin</s:a>
				<ul class="tertiary-links" style="display: none">
					...
					<sec:authorize access="hasAnyRole('ROLE_ADMIN', 'ROLE_ACCOUNT_ADMIN')">
						<li id="userLog"><s:a href="%{modulesAccountURL}accountAdmin/sessionLogAction!view.action">User Log</s:a></li>
					</sec:authorize>
	...
	<s:if test='modulesAccountURL != ""'>
		<sec:authorize access="hasAnyRole('ROLE_ADMIN','ROLE_ACCOUNT_ADMIN','ROLE_ACCOUNT_REVIEWER')">
			<li id="managingAccountsLink"><s:a href="%{modulesAccountURL}accountReviewer/accountReportsAction!requestList.action">Account Reviewer</s:a>
				<ul class="tertiary-links" style="display: none">
					<sec:authorize access="hasAnyRole('ROLE_ADMIN','ROLE_ACCOUNT_ADMIN','ROLE_ACCOUNT_REVIEWER')">
					...
					<sec:authorize access="hasAnyRole('ROLE_ADMIN','ROLE_ACCOUNT_ADMIN','ROLE_ACCOUNT_REVIEWER')">
						<li id="accountReportingLink" class="long-text"><s:a href="%{modulesAccountURL}accountReviewer/accountReportsAction!reportingList.action">Account Reporting Dashboard </s:a></li>
					</sec:authorize>
				</ul>
			</li>
		</sec:authorize>
