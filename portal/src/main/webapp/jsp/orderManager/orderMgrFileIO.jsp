<%@include file="/common/taglibs.jsp"%>
	...
	<div class="lightbox-content-wrapper" >	
		<s:form id="theForm" name="theForm" class="validate" action="orderAction!upload.ajax" method="post"
				...
				<div class="form-field textfield-other" >
					...
					<label for="new_file_upload_filetype"> File Type:</label>
					<s:select headerKey="Other (Not Specified)" headerValue="Other (Not Specified)" list="uploadFileType" name="selectedUploadFileType"  cssClass="textfield float-center"></s:select>
				</div>
				
		</s:form>
		<div class="form-field">
					<div class="button">
						<input id="submitFile" type="submit" class="submit" value="Submit"></input>
					</div>
				</div>
	</div>
...
// 		theForm.submit();
	...
	$(document).ready(function(){
			    ...
			    $("#submitFile").one('click',function(e) {
