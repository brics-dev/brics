...
<div class="border-wrapper">
	<div id="main-content">
		...
		<p>Thank you for your request. You will receive an email shortly containing a link where you can reset your password. If you do not	receive an email within the next 5-10 minutes, please contact an administrator.</p>
