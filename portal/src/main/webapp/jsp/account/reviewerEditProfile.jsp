...
<!-- begin .border-wrapper -->
	<div class="border-wrapper">
		...
		<div id="main-content">
			<div id="breadcrumb">
				<s:if test="%{currentActionName == 'viewAccountRequest' || currentActionName == 'editRequestValidationAction'}">
					<s:a href="%{modulesAccountURL}accountReviewer/accountReportsAction!requestList.action">Account Requests</s:a>
					&nbsp;&gt;&nbsp;
					<a href="viewAccountRequest!viewAccountRequest.action?accountId=${currentAccount.id}">Account Request:<s:property value="accountDetailsForm.userName" /></a>
					&nbsp;&gt;&nbsp;Edit Profile
				</s:if>
				<s:elseif test="%{currentActionName == 'viewAccountRenewal' || currentActionName == 'editRenewalValidationAction'}">
					<s:a href="%{modulesAccountURL}accountReviewer/accountReportsAction!renewalList.action">Account Renewal</s:a>
					&nbsp;&gt;&nbsp;<a href="viewAccountRenewal!viewAccountRenewal.action?accountId=${currentAccount.id}">Account Renewal:<s:property value="accountDetailsForm.userName" /></a>
					&nbsp;&gt;&nbsp;Edit Profile
				</s:elseif>
			</div>
			...
			<div id="mainDiv" class="clear-float">
				...
				<div class="form-field clear-left">
					...
					<s:elseif test="%{currentActionName == 'viewAccountRenewal' || currentActionName == 'editRenewalValidationAction'}">
						...
						<a class="form-link" href="viewAccountRenewal!viewAccountRenewal.action?accountId=${currentAccount.id}">Cancel</a>
					</s:elseif>
				</div>
...
<script type="text/javascript">
	...
	function submitEdit() {
		...
		<s:if test="%{currentActionName == 'viewAccountRequest' || currentActionName == 'editRequestValidationAction'}">
			theForm.action = 'editRequestValidationAction!submit.action';
		</s:if>
		<s:elseif test="%{currentActionName == 'viewAccountRenewal' || currentActionName == 'editRenewalValidationAction'}">
			theForm.action = 'editRenewalValidationAction!submit.action';
		</s:elseif>
		theForm.submit();
	}
</script>