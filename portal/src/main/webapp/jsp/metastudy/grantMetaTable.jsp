...
<div id="grantInfo">
	...
	<div id="grantIdTableContainer" class="idtTableContainer" style="padding-left:50px; padding-top:20px; padding-bottom:10px; width:800px">
		<h4>Grant ID Table</h4>
		<table id="grantIdTable" class="table table-striped table-bordered" width="100%"></table>
	</div>
</div>
...
<script type="text/javascript">
	...
	function addGrant() {
		...
		var oTable = $('#grantIdTable').idtApi('getTableApi');
		$.ajax({
			type: "POST",
			url: "grantMetaValidationAction!addGrant.ajax",
			data: params,
			"async": true,
	...
	function removeGrant(grantJson) {
		...
		$.ajax({
			type: "POST",
			url: "metaStudyAction!removeGrant.ajax",
