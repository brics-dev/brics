<script id="checkboxQuestionTemplate" type="text/x-handlebars-template">
			...
			<div class="questionHeaderLeft col-md-10">
				...
				<div class="statusTooltip" id="statusTooltip_validation">
					...
					<div class="questionValidation_string questionValidation_type">
						Answer must be a one or many of the available options<br />
		...
		<div class="questionBody row">
			...
			<div class="col-md-12">
				...
				<div class="checkboxOptionsContainer" style="display:inline-block" >
				</div>

				<div class="clearfix includeOtherDiv hiddenDiv" >
					<div class="col-md-12"><input type="checkbox"/>&nbsp;&nbsp;<label>Other, Please Specify</label><input type="text"/></div>
				</div>
			</div>
			<div class="col-md-12">
...
<script id="checkboxQuestionInputHorizontalDisplay" type="text/x-handlebars-template">
	<div class="col-md-1 checkboxOptionHorizontal"><input type="checkbox"/>&nbsp;&nbsp;<label title="{{tooltip}}">{{label}}</label></div>
</script>


<script id="checkboxQuestionInputVerticalDisplay" type="text/x-handlebars-template">
		<div class="col-md-12 checkboxOption"><input type="checkbox"/>&nbsp;&nbsp;<label title="{{tooltip}}">{{label}}</label></div>
</script>