...
<script id="editQuestionValidationTabForCAT" type="text/x-handlebars-template">
<div class="tabcontainer" id="dialog_editQuestion_validation">
...
<div class='col-md-6'>
	...
	<div class='ibisMessaging-message ibisMessaging-primary ibisMessaging-error'>This instrument is a computer adaptive test (CAT), so its questions are generated dynamically based on answers given. The validation can not be applied to this form.</div>
