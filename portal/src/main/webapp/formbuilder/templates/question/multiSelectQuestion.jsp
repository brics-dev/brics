<script id="multiSelectQuestionTemplate" type="text/x-handlebars-template">
		...
		<div class="questionBody row clearfix">
			...
			<div class="col-md-12">
				...
				<div class="selectedQuestionContainer" style="display:inline-block"> 
					<select class="questionInput multiSelectedQuestion" multiple="multiple" name="multiSelectedQuestion">
					</select>
				</div>
...
<script id="multiSelectQuestionInput"  type="text/x-handlebars-template">
		<option value="{{optionValue}}" title="{{tooltip}}">{{optionText}}</option>
</script>

<script id="multiSelectQuestionInputOther"  type="text/x-handlebars-template">
		<option value="{{optionValue}}" class="otherspecify" title="{{tooltip}}">{{optionText}}</option>
</script>
