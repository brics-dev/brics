	...
	<div id="dialog_editTextbox" class="formcreator_dialog">
		...
		<div class="tabcontainer row" id="dialog_editQuestion_tab1">
			...
			<div class="row clearfix">
				...
				<div class="col-md-7 basicFormatText" style="display: none;">
			...
			<div class="row clearfix selectQuestionformat" style="display: none;">	
				...
				<div class="col-md-7">
						<p><strong>This question text has had advanced formatting.</strong></p>
						<a href="#" class="defaultText">Return to default(no advanced formatting)</a><br><br>
				</div>
			</div>
			<div class="row clearfix">
				<div class="col-md-2 basicDataElement"  style="display: none;">
					<label>Data Element</label>
				</div>
				<div class="col-md-5 selectDataElement" style="display: none;">
					<label>Data Element</label>
				</div>
				<div class="col-md-7">
