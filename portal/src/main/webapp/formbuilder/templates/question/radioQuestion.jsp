<script id="radioQuestionTemplate" type="text/x-handlebars-template">
			...
			<div class="questionHeaderLeft col-md-10">
				...
				<div class="statusTooltip" id="statusTooltip_validation">
					...
					<div class="questionValidation_string questionValidation_type">
						Answer must be one of the options below<br />
		...
		<div class="questionBody row clearfix">
			...
			<div class="col-md-12">
				...
				<div class="radioOptionsContainer" style="display:inline-block"  >

				</div>
				<div class="clearfix includeOtherDiv hiddenDiv" >
					<div class="col-md-12"><input type="radio"/>&nbsp;&nbsp;<label>Other, Please Specify</label><input type="text"/></div>
				</div>
			</div>
			<div class="col-md-12">
...
<script id="radioQuestionInputHorizontalDisplay" type="text/x-handlebars-template">
	<div class="col-md-1 radioOptionHorizontal"><input type="radio"/>&nbsp;&nbsp;<label title="{{tooltip}}">{{label}}</label></div>
</script>


<script id="radioQuestionInputVerticalDisplay" type="text/x-handlebars-template">
	<div class="col-md-12 radioOption"><input type="radio"/>&nbsp;&nbsp;<label title="{{tooltip}}">{{label}}</label></div>
</script>