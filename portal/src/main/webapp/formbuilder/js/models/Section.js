var Section = BaseModel.extend({
	...
	removeQuestion : function(reference) {
		...
		if (question !== null) {
			...
			if(typeof question !== "undefined" ) {
				FormBuilder.form.existingQuestionsToDelete.push(question.attributes);
			}
	...
	toJsonObj : function(){
		...
		sectionObj.repeatedSectionParent = this.get("repeatedSectionParent");
		sectionObj.repeatableGroupName = this.get("repeatableGroupName");
		sectionObj.id = this.get("id");
		...
		sectionObj.isManuallyAdded = this.get("isManuallyAdded");
		return sectionObj;
	},
