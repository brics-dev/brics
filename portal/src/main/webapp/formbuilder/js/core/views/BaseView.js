...
var BaseView = Backbone.View.extend({
	...
	ellipsis: function (minimized_elements, char_count) {

	    
	    minimized_elements.each(function(){    
	        var t = $(this).text();        
	        if(t.length < char_count) return;
	        
	        $(this).html(
	            t.slice(0,char_count)+'<span>... </span><a style="color: blue; text-decoration: underline;" href="#" class="more">More</a>'+
	            '<span style="display:none;">'+ t.slice(char_count,t.length)+' <a style="color: blue; text-decoration: underline;" href="#" class="less">Less</a></span>'
	        );
