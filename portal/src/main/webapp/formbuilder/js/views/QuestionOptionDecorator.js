...
var QuestionOptionDecorator = {
	...
	events : {
		...
		"change #optionSubmittedValue" : "selectTextSubmittedVal",
		"change #optionChoice" : "selectTextDescription"
	},
	...
	renderOptionCommons : function(model) {
		...
		if(type === Config.questionTypes.radio || type === Config.questionTypes.select){
			if(this.$("#dialog_editQuestion_tab1_container1").length < 1) {
				...
				if (model.get("displayPV")){
					this.$('#dialog_editQuestion_tab1_container2 #optionSubmittedValue').prop("checked", true);
				}else{
					this.$('#dialog_editQuestion_tab1_container2 #optionChoice').prop("checked", true);
				}
	...
	selectTextSubmittedVal : function(event) {
		this.model.set("displayPV", true);
		this.$('#dialog_editQuestion_tab1_container2 #optionChoice').prop("checked", false);
		this.$('#dialog_editQuestion_tab1_container2 #optionSubmittedValue').prop("checked", true);
	},
	
	selectTextDescription : function(event) {
		this.model.set("displayPV", false);
		this.$('#dialog_editQuestion_tab1_container2 #optionChoice').prop("checked", true);
		this.$('#dialog_editQuestion_tab1_container2 #optionSubmittedValue').prop("checked", false);
	},
