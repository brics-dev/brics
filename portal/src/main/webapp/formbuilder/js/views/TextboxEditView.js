...
//		this.registerCommons(this, QuestionPrepopulationDecorator);
	...
	render : function(model) {
		...
		{ 
			...
			//if range value min or max is floating point, disable VS to prevent them from changing Q type to VS
			if( String(this.model.get("rangeValue1")).indexOf(".") != -1 || String(this.model.get("rangeValue2")).indexOf(".") != -1) {
