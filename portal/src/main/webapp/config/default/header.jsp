...
<div id="header">
	...
	<s:else>
		...
		<em class="alt">Biomedical Research Informatics Computing System</em></a>
		<div id="instanceHeaderTwo" class="float-left"><b>BRICS</b>  Biomedical Research Informatics Computing System</div>
