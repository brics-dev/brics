...
<div id="footer">
	<div class="content line">
		<div class="unit size1of2">
			<p>
				<s:a href="%{modulesPublicURL}contact" class="margin-right">Contact Us</s:a>
				<a href="https://www.ninr.nih.gov/site-structure/policies#privacy" target="_blank" class="ext-link reverse margin-right">Privacy Statement</a>
