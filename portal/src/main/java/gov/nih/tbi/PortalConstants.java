...
public class PortalConstants {
	...
	public static final String EXISTING_FILE_TYPES ="existingFileTypes";
	...
	public static final String ACTION_WITHDRAW_REQUEST_LIGHBOX = "withdrawRequestLightbox";
	public static final String ACTION_WITHDRAW_REQUEST_LOGOUT = "withdrawRequestLogout";
	
	public static final String ACTION_PARTIAL_APPROVAL_LIGHBOX = "partialApprovalLightbox";
	
	public static final String ACTION_TEMPORARY_REJECTION_LIGHTBOX = "temporaryRejectionLightbox";
	public static final String ACTION_REJECTION_LIGHTBOX = "rejectionLightbox";
	
	public static final String ACCOUNT_MESSAGE_TEMPLATE_ID ="accountTemplateId";
	public static final String ACCOUNT_AUTOMATED_RENEWAL_REPORT_LIGHTBOX ="automatedRenewalReportLightbox";
	public static final String ACCOUNT_AUTOMATED_REQUEST_REPORT_LIGHTBOX ="automatedRequestReportLightbox";
	
	public static final String CHANGE_FILE_TYPE_LIGHBOX = "changeFileTypeLightbox";
	public static final String CHANGE_FILE_NAME_LIGHBOX = "changeFileNameLightbox";
	...
	public static final String NAMESPACE_ACCOUNT_REVIEWER = "accountReviewer";
	...
	public static final String USER_ACCESS_DENIED = "useraccessdenied";
	...
	public static final String pubmedAbstractWsUrl = "https://www.ncbi.nlm.nih.gov/pubmed/?report=xml&format=text&term=";
	...
	public static final int PUBMED_ABSTRACT_MAX_CHARACTERS = 10000;
	
	// Grant search
	public static final String FEDERAL_REPORTER_SEARCH_URL = "https://federalreporter.nih.gov/projects/search";
	
	public static final String FIELD_EDIT_FORMAT = "The field %s was changed from \"%s\" to \"%s\".";

	public static final String ADD_FILE_LIGHTBOX = "addFileLightbox";
	
	public static final String ADD_PERMISSION_LIGHTBOX = "addPermissionLightbox";
	
	/********* Account Temporary Rejection ****************/
	public static final String MAIL_RESOURCE_TEMP_REJECT = "tempReject";
	public static final String AUTOMATED_TEMP_REJECT_MESSAGE_FORMAT = "Your account has been TEMPORARILY REJECTED with the following reason: [ %s ]. %s<br><br>";
	public static final String AUTOMATED_TEMP_REJECT_MESSAGE_SIMPLE_FORMAT = "Your account has been TEMPORARILY REJECTED with the following reason: %s<br><br>";
