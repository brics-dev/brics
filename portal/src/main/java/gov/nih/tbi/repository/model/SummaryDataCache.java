...
public class SummaryDataCache {
	 ...
	 */
	protected SummaryDataCache(QueryToolManager queryToolManager) {
	 ...
	 */
	public static SummaryDataCache getInstance(QueryToolManager queryToolManager) {
		if (instance == null) {
			instance = new SummaryDataCache(queryToolManager);
		}
		return instance;
	}
	 ...
	 * Empty the cache.
	 */
	public void clearCache(QueryToolManager queryToolManager) {
		updateDate = null;
	...
	protected void initProgramData(List<String> chartNames) {
		...
		for (String chartName : chartNames) {
			...
			if (!programChartData.containsKey(chartName)) {
				SummaryResult singleChartSummaryResult = queryToolManager.getSummaryData(chartName);
	 ...
	 */
	public JsonObject getProgramMultiple(List<String> chartNames) {
	 ...
	 * @return JsonObject representation of the program data
	 */
	public JsonObject getProgramSingle(String chartName) {
	...
	protected void initStudyData(List<String> chartNames, Study study) {
		...
		for (String chartName : chartNames) {
			...
			if (!singleStudyData.containsKey(chartName)) {
				SummaryResult singleChartSummaryResult = queryToolManager.getSummaryData(chartName, null, studyTitle);
				if (singleChartSummaryResult != null) {
					LinkedHashMap<String, String> singleChartData =
							(LinkedHashMap<String, String>) singleChartSummaryResult.getResults();
	...
	public void cacheAllStudies() {
		...
		List<SummaryQuery> queries = queryToolManager.getAllStudySummaryQueriesShortnames();
	...
	public void cacheProgram() {
		List<String> chartNames = new ArrayList<String>();
		List<String> sparqlChartNames = new ArrayList<String>();
		List<SummaryQuery> queries = queryToolManager.getAllProgramSummaryQueriesShortnames();
		for (SummaryQuery query : queries) {
			if (query != null) {
				String shortname = query.getShortname();
				if(query.getRequiresSparql()) {
