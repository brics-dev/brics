...
public class DEEventLogDocumentationAction extends DataElementAction implements DocumentationUploadAction<DataElement> {

	private static final long serialVersionUID = 2230293297082083975L;

	private static final Logger logger = Logger.getLogger(DEEventLogDocumentationAction.class);
	...
	public String getValidationActionName() {
		return PortalConstants.ACTION_DE_EVENT_LOG_VALIDATION;
	}
	...
	public String uploadDocumentation()
		...
		if (isEditingDoc && selectedDocumentName != null) {
			...
			Set<DictionarySupportingDocumentation> currentDocumentations = getSessionDictionaryStatusChange().getDEEventLogDocumentation();
