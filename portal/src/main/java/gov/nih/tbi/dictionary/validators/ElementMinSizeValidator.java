 ...
 * 
 */
public class ElementMinSizeValidator extends FieldValidatorSupport
{
    ...
    public void validate(Object object) throws ValidationException
    {
        ...
        if (DataType.ALPHANUMERIC.equals(type) && !defined && fieldValue != null
                && (fieldValue < 1 || fieldValue > 4000))
        {
            addFieldError(fieldName, "Maximum Allowable Length/Size must be greater than 0 and lesss than 4000");
        }
