...
@Component
public class PortalContextClosedHandler implements ApplicationListener<ContextClosedEvent> {
	private static final Logger logger = Logger.getLogger(PortalContextClosedHandler.class);
