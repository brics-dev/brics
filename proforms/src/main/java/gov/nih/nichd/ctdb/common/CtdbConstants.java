 ...
 * by the CTDB Application across modules.
 *
 * @author Booz Allen Hamilton
 * @version 1.0
 */
public class CtdbConstants {
	//From value indication whether it's single or double entry data collection corresponds to column---->dataentryflag in form table
	...
	public static final String DATACOLLECTION_STATUS_CERTIFIED = "Certified"; // will are not using it in ibis->proforms just put it since we have old code floating around with it

	//colors used by data collection status, to be consistent with the colors in dataCollection.css from line 229 to line 239
	 ...
	 */
	public static final String CRYPTO_PHRASE = "REPLACED";
	public static final String ENCRYPTION_KEY = "REPLACED";
	...
	public static final String URL_HOST_FITBIR_DEV ="https://REPLACED";
	public static final String URL_HOST_PDBBP_DEV = "https://REPLACED";
	
	/** 
	 * Global URL Environments on Stage
	 */

	public static final String URL_HOST_FITBIR_STAGE ="https://REPLACED";
	public static final String URL_HOST_PDBP_STAGE = "https://REPLACED";
	public static final String URL_HOST_CISTAR_STAGE ="https://REPLACED";
	public static final String URL_HOST_NEI_STAGE ="https://REPLACED";
	public static final String URL_HOST_CDRNS_STAGE ="https://REPLACED";

	
	/** 
	 * Global URL Environments on UAT
	 */
	public static final String URL_HOST_FITBIR_UAT ="https://REPLACED";
	public static final String URL_HOST_PDBP_UAT = "https://REPLACED";
	...
	/**
	 * CTDB Constant used as the key to retrieve the uses tab attribute from the request. This is used
	 * to determine if the JSPs uses tabs to display data.
	 */
	...
	/**
	 * The tag used to designate the name for "Other" option and code in checkbox, select, multi-select and radio question 
	 */    
	...
	public static final String SUPER_USER_USERNAME = "REPLACED";
	public static final String SUPER_USER_PASSWORD = "REPLACED";
	 ...
	 */
	public static final List<String> IMAGE_FORMATS = Collections.unmodifiableList(Arrays.asList("jpg", "gif", "jpeg", "png"));
	...
	//public static final List<String> PREDEFINED_VISIT_TYPE_LIST = Collections.unmodifiableList(Arrays.asList("6 months", "12 months","18 months","24 months","30 months","36 months","42 months","48 months","54 months","60 months","Baseline","Screening"));
