 ...
 * @version 1.0
 */
public class DataEntrySummaryIdtDecorator extends IdtDecorator {

	/**
	 * Default Constructor
	 */
	public DataEntrySummaryIdtDecorator() {
		super();
	}
	...
	public String getFormNameForAdminForm() throws JspException {
		...
		String url = root + "/form/viewFormDetail.action?source=popup&id=" + formId;
		String anchorTag = "<a href=\"Javascript:popupWindowWithMenu('" + url + " ');\">" + name+ "</a>";
	...
	public String getScheduledVisitDate() throws JspException {
		AdministeredForm adminedForm = (AdministeredForm) this.getObject();
		return adminedForm.getsVisitDate();
	}
