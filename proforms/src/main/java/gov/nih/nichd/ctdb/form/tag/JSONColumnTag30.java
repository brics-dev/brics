...
/**
 * This tag works hand in hand with the JSONTag to display a list of
 * objects.  This describes a column of data in the JSONTag table.  There can
 ...
 * JSONTag does all the work based on the information provided in the
 ...
 *   
 *   orderable       - can this column be sorted?  Default is false
 *</pre></p>
 */

public class JSONColumnTag30 extends BodyTagSupport implements Cloneable {
    ...
    private String orderable = "false";
    
    private boolean rowInput = false;
    ...
    public int doEndTag() throws JspException {
        ...
        JSONColumnTag30 copy = this;
        try {
            copy = (JSONColumnTag30) this.clone();
        }
        catch (CloneNotSupportedException e) {
        } // shouldn't happen...

        ((JSONTag30) parent).addColumn(copy);
	...
	public void setRowInput(boolean rowInput) {
