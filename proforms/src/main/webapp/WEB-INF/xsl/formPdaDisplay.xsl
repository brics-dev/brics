                                ...
                                <xsl:choose>
                                    ...
                                    <xsl:when test="@type = 'Radio'">
                                        ...
                                        <xsl:for-each select="answers/answer">
                                            ...
                                            <xsl:choose>
                                                <xsl:when test="$default = display">
                                                    <input type="radio" id="Q_{$qid}" name="Q_{$qid}" value="{display}"  onfocus="checkButtons(this);" checked="true" title="{display/@displayToolTip}" onchange="applyskiprule(this, [{$questionsToSkip}], '{$skipOperator}','{$skipRule}','{$skipRuleEquals}')" onMouseDown="toggleRadio(this);">
                                                        <xsl:value-of select="display"/>
                                                    </input>
                                                </xsl:when>
                                                <xsl:otherwise>
