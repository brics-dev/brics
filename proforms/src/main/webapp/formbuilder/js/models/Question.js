var Question = BaseModel.extend({
	...
	updateVScale : function() {
		...
		if (vinfo != "") {
			...
			this.set("vscaleLeftText", visualScale[0], {silent: true});
			this.set("vscaleCenterText", visualScale[1], {silent: true});
			this.set("vscaleRightText", visualScale[2], {silent: true});
			this.set("vscaleRangeStart", visualScale[3], {silent: true});
			this.set("vscaleRangeEnd", visualScale[4], {silent: true});
			this.set("vscaleWidth", visualScale[5], {silent: true});
			var scaleCursor = (visualScale[6] == "f") ? false : true;
			this.set("vscaleShowHandle", scaleCursor, {silent: true});
		}
	},
