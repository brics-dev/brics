    ...
    _.extend(Backbone.ModelBinder.prototype, {
        ...
        _setElValue:function (el, convertedValue) {
            if(el.attr('type')){
            	...
            	// Joshua Park modified this line from the commented out value
            	// to allow users of the system to write HTML and store that in
            	// models.
            	// see https://github.com/theironcook/Backbone.ModelBinder/issues/176
            	// for official ticket about the issue (not written by JP)
            	//el.text(convertedValue || (convertedValue === 0 ? '0' : ''));
                el.html(convertedValue || (convertedValue === 0 ? '0' : ''));
            }
        },
