<script id="visualScaleQuestionTemplate" type="text/x-handlebars-template">
		...
		<div class="questionBody row">
			...
			<div class="col-md-12">
				...
				<div class="vsContainer" style="width: {{vscaleWidth}}mm">
					<div class="row">
						<div name="vscaleLeftText"  class="col-md-2"></div>
						<div class="col-md-8">
								<div class="row">
									<div id="sliderEx" class="slider ui-slider ui-slider-horizontal ui-widget ui-widget-content ui-corner-all col-md-12">
								...
								<div class="row">
									<div name="vscaleCenterText" class="col-md-12 textAlignCenter"></div>
								</div>	
						</div>		
						<div   name="vscaleRightText" class="col-md-2"></div>
					</div>			
