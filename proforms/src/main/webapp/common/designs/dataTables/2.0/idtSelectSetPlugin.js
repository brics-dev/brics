	...
	$.fn.dataTable.SelectSet = function(table, opts) {
		...
		function selectAllServerCallback(event) {
			...
			$.ajax({
			 ...
			 api.one('preXhr', function(e, s, data) {
                 ...
                 api.one('preDraw', function(e, s) {
                     // Call the original action function
                     opts.rowsData = s.aoData.map(function(row) {
                    	 return row._aData;
                     })
                     console.log(s.aoData.length);
