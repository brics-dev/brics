...
// TemplateManager
var TemplateManager={templates:{},addTemplate:function(e,t){if(!_.isFunction(t)){throw new Error("template "+e+" is invalid during registration")}this.templates[e]=t},getTemplate:function(e){var t=this.templates[e];if(typeof t==="undefined"||t===null){try{t=this._retrieveTemplate(e)}catch(n){throw n}}return t},initPartials:function(){$(".handlebarsPartial").each(function(){var e=$(this);Handlebars.registerPartial(e.attr("id"),e.html())})},initOnePartial:function(e){var t=$("#"+e);if(t.length>0){var n=t.html();if(n!==""){Handlebars.registerPartial(t.attr("id"),n)}else{throw new Error("partial "+e+" is empty")}}else{throw new Error("partial "+e+" not found")}},_retrieveTemplate:function(e){var t=$("#"+e);if(t.length>0){var n=t.html();if(n!==""){var r=Handlebars.compile(n);this.addTemplate(e,r);return r}else{throw new Error("template "+e+" is empty")}}else{throw new Error("template "+e+" not found")}}}
