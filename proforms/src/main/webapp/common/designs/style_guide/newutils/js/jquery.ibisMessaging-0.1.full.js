 ...
 * flash messages (temporary messages), popup messages, and persistent top-of-the
 * page messages.
 * 
 * Dependencies:
 * 		jQuery
 * 		jQuery UI
 * 		jquery.cookie.js from https://github.com/carhartl/jquery-cookie for cookie function
 * 		JSON-2 javascript package
 * 
 * @author Joshua Park
 */
(function($) {
