...
<div align="right">
		<input type="button" value="Save as New" onclick="inProgressSaveAsNew()" id="inProgressSaveAsNew" />
		<input type="button" value="Edit form" onclick="inProgressEditForm()" id="inProgressEditForm" />
</div>
