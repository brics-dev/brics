 ...
 */
public class UserDetailsByAuthServiceWrapper implements AuthenticationUserDetailsService, InitializingBean
{
     ...
     */
    public UserDetailsByAuthServiceWrapper()
    {
     ...
     */
    public UserDetailsByAuthServiceWrapper(final UserDetailsService userDetailsService)
    {
            ...
            DataAccessException
    {
        ...
        try
        {
            return ((AccountDetailService) userDetailsService).loadUserByAuthentication(authentication);
        }
