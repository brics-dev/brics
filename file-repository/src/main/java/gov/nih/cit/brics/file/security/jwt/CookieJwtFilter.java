 ...
 */
public class CookieJwtFilter extends GenericFilterBean {
	public static final String AUTHORIZATION_HEADER = "downloadAuth";
	public static final String BEARER_HEADER = "Bearer ";

	private EurekaTokenProvider tokenProvider;

	public CookieJwtFilter(EurekaTokenProvider tokenProvider) {
	...
	private String resolveToken(HttpServletRequest request) {
		Cookie authCookie = WebUtils.getCookie(request, AUTHORIZATION_HEADER);
		if (authCookie != null) {
