...
public class ReportingModulesConstants {
	...
	public void setWsSet(boolean wsSecuredArg) {
		...
		ReportingModulesConstants.wsSecured = wsSecuredNonStatic;
	}

	public void setDefaultStylingKey(boolean stylingKeyArg) {
		ReportingModulesConstants.modulesStyleDefaultStat = this.modulesStyleDefault;
	}
	...
	public String getModulesOrgName() {
		...
		if (modulesOrgName == null || modulesOrgName.isEmpty()) {
			...
			return modulesOrgNameMap.get(ReportingServiceConstants.DEFAULT_PROVIDER);
		}
	}
	...
	public String getModulesOrgEmail() {
		...
		if (modulesOrgEmail == null || modulesOrgEmail.isEmpty()) {
			...
			return modulesOrgEmailMap.get(ReportingServiceConstants.DEFAULT_PROVIDER);
		}
	}
	...
	public String getModulesOrgNoreply() {
		...
		if (modulesOrgNoreply == null || modulesOrgNoreply.isEmpty()) {
			...
			return modulesOrgNoreplyMap.get(ReportingServiceConstants.DEFAULT_PROVIDER);
		}
	}
	...
	public String getModulesOrgPhone() {
		...
		if (modulesOrgPhone == null || modulesOrgPhone.isEmpty()) {
			...
			return modulesOrgPhoneMap.get(ReportingServiceConstants.DEFAULT_PROVIDER);
		}
	}
	...
	public String getModulesPublicURL() {
		...
		if (modulesPublicURL == null || modulesPublicURL.isEmpty()) {
			...
			return modulesPublicMap.get(ReportingServiceConstants.DEFAULT_PROVIDER);
		}
	}
	...
	public String getModulesPFURL() {
		...
		if (modulesPFURL == null || modulesPFURL.isEmpty()) {
			...
			return modulesPFMap.get(ReportingServiceConstants.DEFAULT_PROVIDER);
		}
	}
	...
	public String getModulesDDTURL() {
		...
		if (modulesDDTURL == null || modulesDDTURL.isEmpty()) {
			...
			return modulesDDTMap.get(ReportingServiceConstants.DEFAULT_PROVIDER);
		}
	}
	...
	public String getModulesQTURL() {
		...
		if (modulesQTURL == null || modulesQTURL.isEmpty()) {
			...
			return modulesQTMap.get(ReportingServiceConstants.DEFAULT_PROVIDER);
		}
	}
	...
	public String getModulesReportingURL() {
		...
		if (modulesReportingURL == null || modulesReportingURL.isEmpty()) {
			...
			return modulesReportingMap.get(ReportingServiceConstants.DEFAULT_PROVIDER);
		}
	}
	...
	public String getModulesOMURL() {
		...
		if (modulesOMURL == null || modulesOMURL.isEmpty()) {
			...
			return modulesOMMap.get(ReportingServiceConstants.DEFAULT_PROVIDER);
		}
	}
	...
	public String getModulesMSURL() {
		...
		if (modulesMSURL == null || modulesMSURL.isEmpty()) {
			...
			return modulesMSMap.get(ReportingServiceConstants.DEFAULT_PROVIDER);
		}
	}
	...
	public String getModulesVTURL() {
		...
		if (modulesVTURL == null || modulesVTURL.isEmpty()) {
			...
			return modulesVTMap.get(ReportingServiceConstants.DEFAULT_PROVIDER);
		}
	}
	...
	public String getModulesGTURL() {
		...
		if (modulesGTURL == null || modulesGTURL.isEmpty()) {
			...
			return modulesGTMap.get(ReportingServiceConstants.DEFAULT_PROVIDER);
		}
	}
	...
	public String getModulesSTURL() {
		...
		if (modulesSTURL == null || modulesSTURL.isEmpty()) {
			...
			return modulesSTMap.get(ReportingServiceConstants.DEFAULT_PROVIDER);
		}
	}
	...
	public String getModulesUDTURL() {
		...
		if (modulesUDTURL == null || modulesUDTURL.isEmpty()) {
			...
			return modulesUDTMap.get(ReportingServiceConstants.DEFAULT_PROVIDER);
		}
	}
	...
	public String getModulesDTURL() {
		...
		if (modulesDTURL == null || modulesDTURL.isEmpty()) {
			...
			return modulesDTMap.get(ReportingServiceConstants.DEFAULT_PROVIDER);
		}
	}
	...
	public String getModulesAccountURL() {
		...
		if (modulesAccountURL == null || modulesAccountURL.isEmpty()) {
			...
			return modulesAccountMap.get(ReportingServiceConstants.DEFAULT_PROVIDER);
		}
	}
	...
	public String getSaltedAdministratorPassword(Long diseaseId) {
		...
		if (saltedPasswordMap.size() == 1) {
			return saltedPasswordMap.get(ReportingServiceConstants.DEFAULT_PROVIDER);
		}
	...
	public String getStylingKey(Long diseaseId) {
		...
		if (this.modulesStylingMap.size() == 1) {
			result = this.modulesStylingMap.get(ReportingServiceConstants.DEFAULT_PROVIDER);
	...
	public List<Long> getDuplicateModules() {
		...
		if (modulesDuplicates == null || modulesDuplicates.equals(ReportingServiceConstants.EMPTY_STRING)) {
			return duplicateList;
		}
	...
	private Map<Long, String> getURLMap(String inputString) {
		...
		if (!inputString.contains(",") && !inputString.contains(";")) {
			...
			map.put(ReportingServiceConstants.DEFAULT_PROVIDER, inputString);
		} else {
			for (String keyValue : inputString.split(" *; *")) {
				...
				if (map.get(ReportingServiceConstants.DEFAULT_PROVIDER) == null) {
					map.put(ReportingServiceConstants.DEFAULT_PROVIDER, pairs.length == 1 ? "" : pairs[1]);
				}
			}
		}
		return map;
	...
	public String getGuidPrefix(Long diseaseId) {
		...
		if (modulesDTMap.size() == 1) {
			return guidPrefixMap.get(ReportingServiceConstants.DEFAULT_PROVIDER);
		}
	...
	public String getGuidInvPrefix(Long diseaseId) {
		...
		if (guidInvPrefixMap.size() == 1) {
			return guidInvPrefixMap.get(ReportingServiceConstants.DEFAULT_PROVIDER);
		}
	...
	public List<String> getBiorepositoryIuCatalogs() {
		return BRICSStringUtils.delimitedStringToList(this.biorepositoryIuCatalogs, ReportingServiceConstants.COMMA);
	}
	...
	public String getModulesGTServiceURL() {
		if (modulesGTServiceURL == null || modulesGTServiceURL.isEmpty()) {
			...
			return modulesGTServiceMap.get(ReportingServiceConstants.DEFAULT_PROVIDER);
		}
	}
	...
	public static String getDefaultStylingKey() {
		return ReportingModulesConstants.modulesStyleDefaultStat;
	}
