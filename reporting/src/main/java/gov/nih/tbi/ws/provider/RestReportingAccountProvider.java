...
public class RestReportingAccountProvider extends RestAuthenticationProvider {

	private static final Logger log = LogManager.getLogger(RestReportingAccountProvider.class);
	 ...
	 */
	public RestReportingAccountProvider(String serverLocation, String proxyTicket) {
	 ...
	 * @param wsSecure
	 */
	public RestReportingAccountProvider(String serverLocation, String proxyTicket, boolean wsSecure) {
	...
	public Account getUserAccountByUserName(String userName, String path /* constants.getAccountWebServiceURL() */)
		...
		WebClient client = WebClient.create(path + "/" + userName);
	...
	public EntityMap getSavedQueryEntityPermission(Account account, Long entityId,
		...
		EntityMap em = client.accept(MediaType.TEXT_XML).get(EntityMap.class);
	...
	public QueryPermissions getQueryPermission(Account account,
		...
		WebClient client = WebClient.create(path + "?ticket=" + getEncodedTicket());
