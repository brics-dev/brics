...
public class AccountUserDetails implements UserDetails
{
    ...
    public String getPassword()
    {
        ...
        {
            hex.append(ReportingConstants.HEXES.charAt((b & 0xF0) >> 4)).append(ReportingConstants.HEXES.charAt((b & 0x0F)));
        }
    ...
    public boolean isAccountNonExpired()
    {
        ...
        // A user must have an active "USER_ROLE" or "ADMIN_ROLE"
        {
            ...
            if (account.getLastSuccessfulLogin() != null
                    && (adminRole == null || !RoleStatus.ACTIVE.equals(adminRole.getRoleStatus()) || adminRole
                            .isExpired()))
            {
                ...
                // add ## number of days
                cal.add(Calendar.DAY_OF_YEAR, ReportingConstants.EXPIRE_ACCOUNT_AFTER_DAYS);
            ...
            if (adminRole == null || !RoleStatus.ACTIVE.equals(adminRole.getRoleStatus()) || adminRole.isExpired())
            {
                // If the user doesn't have a user role, that is active and not expired then return false
                if (userRole == null || !RoleStatus.ACTIVE.equals(userRole.getRoleStatus()) || userRole.isExpired())
                {
                    return false;
                }
            }
    ...
    public boolean isEnabled()
    {
        ...
        if (!(AccountStatus.ACTIVE.equals(account.getAccountStatus()) || (AccountStatus.PENDING.equals(account
                .getAccountStatus()))))
        {
            return false;
        }
