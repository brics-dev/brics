...
<html>
	<head>
		...
		<c:if test="${fn:contains(pageContext.request.requestURL, 'ninds')}">  
			<link type="text/css" href="css/scss/instances/nindes/style.css" rel="stylesheet" />
		</c:if> 
		...
		<!-- Templates -->
		<jsp:include page='/template/main/login.jsp' />
		<jsp:include page='/template/processing.jsp' />
