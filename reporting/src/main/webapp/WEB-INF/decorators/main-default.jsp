...
<title><decorator:title /> : BRICS : Biomedical Research Informatics Computing System</title>

<link href="<s:url value='/config/default/style.css'/>" rel="stylesheet" type="text/css" media="all" />
<link href="<s:url value='/config/default/images/favicon.ico'/>" rel="icon" />
...
<jsp:include page="/common/envBanner.jsp" />
	...
	<s:if test="eFormModule eq null">
			<jsp:include page="/config/default/header.jsp" />
	</s:if>
	...
	<s:else>
		...
		<div id="footerDiv">
			<jsp:include page="/config/default/footer.jsp" />
		</div>
	</div>
</body>
</html>