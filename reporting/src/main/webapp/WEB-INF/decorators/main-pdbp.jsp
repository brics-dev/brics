...
<title><decorator:title /> : PDBP DMR : Parkinson's Disease Biomarkers Project Data Management Resource</title>
...
<jsp:include page="/common/envBanner.jsp" />
	...
	<s:if test="eFormModule eq null">
			<jsp:include page="/config/pdbp/header.jsp" />
	</s:if>
	...
	<s:else>
		...
		<div id="footerDiv">
			<jsp:include page="/config/pdbp/footer.jsp" />
		</div>
	</div>
</body>
</html>