...
<title><decorator:title /> : EYEGENE : The National Ophthalmic Disease Genotyping and Phenotyping Network</title>
...
<jsp:include page="/common/envBanner.jsp" />
	...
	<s:if test="eFormModule eq null">
		<jsp:include page="/config/eyegene/header.jsp" />
	</s:if>
	...
	<s:else>
		...
		<div id="footerDiv">
			<jsp:include page="/config/eyegene/footer.jsp" />
		</div>
	</div>
</body>
</html>