...
<title><decorator:title /> : CISTAR : Federal Interagency Traumatic Brain Injury Research Informatics System</title>
...
<jsp:include page="/config/cistar/google-analytics.jsp" />
...
<jsp:include page="/common/envBanner.jsp" />
	...
	<s:if test="eFormModule eq null">
		<jsp:include page="/config/cistar/header.jsp" />
	</s:if>
	...
	<s:else>
		...
		<div id="footerDiv">
			<jsp:include page="/config/cistar/footer.jsp" />
		</div>
	</div>
</body>
</html>