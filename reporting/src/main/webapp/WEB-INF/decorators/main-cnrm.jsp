...
<title><decorator:title /> : CNRM : Center for Neuroscience and Regenerative Medicine</title>

<link href="<s:url value='/config/cnrm/style.css'/>" rel="stylesheet" type="text/css" media="all" />
<link href="<s:url value='/config/cnrm/images/favicon.ico'/>" rel="icon" type="image/x-icon" />
...
<jsp:include page="/common/envBanner.jsp" />
	...
	<s:if test="eFormModule eq null">
		<jsp:include page="/config/cnrm/header.jsp" />
	</s:if>
	...
	<s:else>
		...
		<div id="footerDiv">
			<jsp:include page="/config/cnrm/footer.jsp" />
		</div>
	</div>
</body>
</html>