...
<title><decorator:title /> : NINDS Common Data Elements</title>
...
<jsp:include page="/config/ninds/google-analytics.jsp" />
...
<jsp:include page="/common/envBanner.jsp" />
	...
	<s:if test="eFormModule eq null">
			<jsp:include page="/config/ninds/header.jsp" />
	</s:if>
	...
	<s:else>
		...
		<div id="footerDiv">
			<jsp:include page="/config/ninds/footer.jsp" />
		</div>
	</div>
</body>
</html>