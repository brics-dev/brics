                                ...
                                <xsl:when test="@type = 'Select'">
                                      ...
                                      <xsl:for-each select="answers/answer">
                                            ...
                                            <xsl:choose>
                                                <xsl:when test="$default = display">
                                                    <input type="radio" id="Q_{$qid}" name="Q_{$qid}" value="{display}" checked="true" onfocus="checkButtons(this);" onMouseDown="toggleRadio(this);">
                                                        <xsl:value-of select="display"/>
                                                    </input>
                                                </xsl:when>
                                                <xsl:otherwise>
                                                    <input type="radio" id="Q_{$qid}" name="Q_{$qid}" value="{display}" onfocus="checkButtons(this);" onMouseDown="toggleRadio(this);">
                                                        <xsl:value-of select="display"/>
                                                    </input>
                                                </xsl:otherwise>
                                            </xsl:choose>
                                    ...
                                    <xsl:when test="@type = 'Multi-Select'">
                                        ...
                                        <xsl:for-each select="answers/answer">
                                                    <xsl:choose>
                                                        <xsl:when test="$default = display">
                                                            <input type="checkbox" id="Q_{$qid}" name="Q_{$qid}" value="{display}" checked="true" onfocus="checkButtons(this);">
                                                                <xsl:value-of select="display"/>
                                                            </input>
                                                        </xsl:when>
                                                        <xsl:otherwise>
                                                            <input type="checkbox" id="Q_{$qid}" name="Q_{$qid}" value="{display}" onfocus="checkButtons(this);">
                                                                <xsl:value-of select="display"/>
                                                            </input>
                                                        </xsl:otherwise>
                                                    </xsl:choose>
                                ...
                                <xsl:choose>
                                    ...
                                    <xsl:when test="@type = 'Select'">
                                      ...
                                      <xsl:for-each select="answers/answer">
                                            ...
                                            <xsl:choose>
                                                <xsl:when test="$default = display">
                                                    <input type="radio" id="Q_{$qid}" name="Q_{$qid}" value="{display}" checked="true" onfocus="checkButtons(this);"  onchange="applyskiprule(this, [{$questionsToSkip}], '{$skipOperator}','{$skipRule}','{$skipRuleEquals}')" onMouseDown="toggleRadio(this);">
                                                        <xsl:value-of select="display"/>
                                                    </input>
                                                </xsl:when>
                                                <xsl:otherwise>
                                                    <input type="radio" id="Q_{$qid}" name="Q_{$qid}" value="{display}" onfocus="checkButtons(this);"  onchange="applyskiprule(this, [{$questionsToSkip}], '{$skipOperator}','{$skipRule}','{$skipRuleEquals}')" onMouseDown="toggleRadio(this);">
                                                        <xsl:value-of select="display"/>
                                                    </input>
                                                </xsl:otherwise>
                                            </xsl:choose>
                                    ...
                                    <xsl:when test="@type = 'Multi-Select'">
                                        ...
                                        <xsl:for-each select="answers/answer">
                                            <xsl:choose>
                                                <xsl:when test="$default = display">
                                                    <input type="checkbox" id="Q_{$qid}" name="Q_{$qid}" value="{display}" checked="true" onfocus="checkButtons(this);" onchange="applyskiprule(this, [{$questionsToSkip}], '{$skipOperator}','{$skipRule}','{$skipRuleEquals}')">
                                                        <xsl:value-of select="display"/>
                                                    </input>
                                                </xsl:when>
                                                <xsl:otherwise>
                                                    <input type="checkbox" id="Q_{$qid}" name="Q_{$qid}" value="{display}" onfocus="checkButtons(this);" onchange="applyskiprule(this, [{$questionsToSkip}], '{$skipOperator}','{$skipRule}','{$skipRuleEquals}')">
                                                        <xsl:value-of select="display"/>
                                                    </input>
                                                </xsl:otherwise>
                                            </xsl:choose>
                                    ...
                                    <xsl:when test="@type = 'Radio'">
                                        ...
                                        <xsl:for-each select="answers/answer">
                                            ...
                                            <xsl:choose>
                                                <xsl:when test="$default = display">
                                                    <input type="radio" id="Q_{$qid}" name="Q_{$qid}" value="{display}"  onfocus="checkButtons(this);" checked="true" onchange="applyskiprule(this, [{$questionsToSkip}], '{$skipOperator}','{$skipRule}','{$skipRuleEquals}')" onMouseDown="toggleRadio(this);">
                                                        <xsl:value-of select="display"/>
                                                    </input>
                                                </xsl:when>
                                                <xsl:otherwise>
