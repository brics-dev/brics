...
<div id="footer">
	<div class="content line">
		<div class="unit size1of2">
			<p>
				<s:a href="%{modulesPublicURL}/site-map" class="margin-right">Site Map</s:a>
				<s:a href="%{modulesPublicURL}/contact-us" class="margin-right">Contact Us</s:a>
				<s:a href="%{modulesPublicURL}/privacy" class="margin-right">Privacy Statement</s:a>
