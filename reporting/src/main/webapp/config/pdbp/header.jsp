...
<div id="header">
	...
	<s:else>
		...
		<em class="alt">Parkinson's Disease Biomarkers Program</em></a>
		<div id="instanceHeaderTwo" class="float-left"><b>PDBP DMR</b>  Parkinson's Disease Biomarkers Program Data Management Resources</div>
