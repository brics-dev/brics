...
<c:set var="instanceKey"><spring:eval expression="@applicationProperties.getProperty('instance.diseaseKey')" /></c:set>
<cas:serviceResponse xmlns:cas='http://www.yale.edu/tp/cas'>
	<cas:authenticationSuccess>
		<cas:user>${fn:escapeXml(principal.id)}</cas:user>
		<cas:attributes>
			<cas:disease><c:out value="${instanceKey}" /></cas:disease>
		</cas:attributes>
