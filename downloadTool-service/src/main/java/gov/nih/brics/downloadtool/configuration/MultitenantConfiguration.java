...
import gov.nih.brics.downloadtool.multitenant.MultiTenantDataSource;
 ...
 * and intended to allow for multiple database connections per application
 *
 */
@Configuration
public class MultitenantConfiguration {
	public static final String META_FILENAME = "meta.properties";
	public static final String DEFAULT_TENANT_ID = "pdbp";
	...
	public DataSource dataSource() {
		...
		for(File propertyFile : files) {
			if (propertyFile != null) {
				...
				DataSourceBuilder<MultiTenantDataSource> dataSourceBuilder = (DataSourceBuilder<MultiTenantDataSource>) DataSourceBuilder.create(this.getClass().getClassLoader());
