...
public class GenericRepoDaoImpl<T, PK extends Serializable> extends GenericDaoImpl<T, PK> {

	public GenericRepoDaoImpl(final Class<T> persistentClass, SessionFactory sessionFactory) {
