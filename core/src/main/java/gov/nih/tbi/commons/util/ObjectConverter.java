 ...
 * </pre>
 * 
 * Not all possible conversions are implemented. You can extend the <tt>ObjectConverter</tt> easily by just adding a new
 * method to it, with the appropriate logic. For example:
 * 
 * <pre>
 * 
 * 
...
public final class ObjectConverter
{
    ...
    public static RepeatableType stringToRepeatableType(String stringType)
    {

        return RepeatableType.valueOf(stringType);
    }

    public static DataType stringToDataType(String stringType)
    {
        for(DataType dataType:DataType.values())
        {
            if(dataType.getValue().equals(stringType))
            {
                return dataType;
            }
        }
