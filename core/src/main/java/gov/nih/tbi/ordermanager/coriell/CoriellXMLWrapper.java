...
import gov.nih.tbi.ordermanager.coriell.Order.OrderMetadata;
...
public class CoriellXMLWrapper
{
    ...
    public CoriellXMLWrapper(gov.nih.tbi.ordermanager.model.BiospecimenOrder bricsOrder) throws JAXBException
    {
    ...
    public CoriellXMLWrapper(gov.nih.tbi.ordermanager.model.BiospecimenOrder bricsOrder, BioRepository repo)
    ...
    public CoriellXMLWrapper(InputStream is) throws JAXBException
    {
    ...
    public Order createSampleOrder(gov.nih.tbi.ordermanager.model.BiospecimenOrder bricsOrder)
    {
        ...
        order.setUser(createCoriellUser(bricsOrder));
        ...
        for (gov.nih.tbi.ordermanager.model.BiospecimenItem bricsItem : bricsOrder.getRequestedItems())
        {
            if (repo == null || repo.getId().equals(bricsItem.getBioRepository().getId()))
                reqsListElement.getSampleRequest().add(createCoriellSampleRequest(bricsItem));
        }
    ...
    private User createCoriellUser(gov.nih.tbi.ordermanager.model.BiospecimenOrder bricsOrder)
    {
    ...
    private SampleRequest createCoriellSampleRequest(gov.nih.tbi.ordermanager.model.BiospecimenItem bricsRequestItem)
    {
