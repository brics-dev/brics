...
public class StudyDataParam   {
  @JsonProperty("studyForms")
  @Valid
  private List<BasicStudyForm> studyForms = new ArrayList<>();
  ...
  **/
  ...
  @NotNull
  @Valid
@Size(min=1)   public List<BasicStudyForm> getStudyForms() {
    return studyForms;
  }

  public void setStudyForms(List<BasicStudyForm> studyForms) {
