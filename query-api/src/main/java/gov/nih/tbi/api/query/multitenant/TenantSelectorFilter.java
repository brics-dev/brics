...
import gov.nih.tbi.api.query.configuration.BricsConfiguration;
...
public class TenantSelectorFilter extends GenericFilterBean {
	...
	public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain)
		...
		// get the tenant name from EITHER the JWT (for service-to-service calls) or the
		// tenant ID (for external calls)
