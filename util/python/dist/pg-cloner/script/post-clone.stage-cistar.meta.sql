...
values ('tbi_sftp_server', 'cistar-host-stage.cit.nih.gov', 'cistar_data_drop', '<CHANGEME>', null, 22, 1);
--SFTP info for documents server
insert into datafile_endpoint_info
values ('documents_sftp_server', 'cistar-host-stage.cit.nih.gov', 'cistar_data_drop', '<CHANGEME>', null, 22, 2);
