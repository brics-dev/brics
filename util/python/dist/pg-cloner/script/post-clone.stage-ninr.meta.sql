...
values ('ninr_sftp_server', 'ninr-host-stage.cit.nih.gov', 'ninr_data_drop', '<CHANGEME>', null, 22, 1);
--SFTP info for documents server
insert into datafile_endpoint_info
values ('documents_sftp_server', 'ninr-host-stage.cit.nih.gov', 'ninr_data_drop', '<CHANGEME>', null, 22, 2);
