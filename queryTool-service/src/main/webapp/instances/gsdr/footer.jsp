...
<div class="footerContent">
	<div class="content">
		<div class="contact">
			<h4>
				Global Stroke Data Repository (GSDR) System
			</h4>
			<br />
			<p>
		...
		<div class="contact">
			...
			<ul class="footer-links footer-logos">
				<li><a href="http://cit.nih.gov" target="_blank"><img
						src="images/cit_logo-bw.png"/ width="101" height="82" border="0" alt="CIT"/></a></li>
				<li><a href="http://ninds.nih.gov/" target="_blank"><img
						src="images/ninds_logo-bw.png" width="101" height="82" border="0" alt="NINDS"/></a></li>
					
			</ul>
			<ul class="footer-links footer-logos">
				
				<li><a href="http://www.hhs.gov/" target="_blank"><img
						src="images/hhs_logo-bw.png" width="50" height="50" border="0" alt="HHS"/></a></li>
				<li><a href="http://www.nih.gov/" target="_blank"><img
						src="images/nih_logo-bw.png" width="101" height="82" border="0" alt="NIH" /></a></li>
				<li><a href="http://www.usa.gov/" target="_blank"><img
						src="images/usagov_logo-bw.png" width="100" height="31" border="0" alt="USA.gov"/></a></li>	
			</ul>
		</div>
